...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.details_item_tab.sizePolicy().hasHeightForWidth())
        self.details_item_tab.setSizePolicy(sizePolicy)
        self.details_item_tab.setFocusPolicy(QtCore.Qt.NoFocus)
        self.details_item_tab.setTabPosition(QtGui.QTabWidget.North)
        self.details_item_tab.setTabShape(QtGui.QTabWidget.Rounded)
        ...
        self.property_settings_scroll_area = QtGui.QScrollArea()
        self.property_settings_scroll_area.setWidgetResizable(True)
        self.property_settings_scroll_area.setObjectName("property_settings_scroll_area")
        self.property_settings_parent = QtGui.QWidget()
        self.property_settings_parent.setGeometry(QtCore.QRect(0, 0, 416, 442))
        self.property_settings_parent.setObjectName("property_settings_parent")
        self.verticalLayout_property = QtGui.QVBoxLayout(self.property_settings_parent)
        self.verticalLayout_property.setSpacing(-1)
        self.verticalLayout_property.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_property.setObjectName("verticalLayout_property")
        self.property_settings = CustomSettingsWidget(self.property_settings_parent)
        self.property_settings.setObjectName("property_settings")
        self.verticalLayout_property.addWidget(self.property_settings)
        spacerItem13 = QtGui.QSpacerItem(20, 20, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_property.addItem(spacerItem13)
        self.verticalLayout_property.setStretch(1, 10)
        self.property_settings_scroll_area.setWidget(self.property_settings_parent)
        self.details_item_tab.addTab(self.property_settings_scroll_area, "")
        ...
        spacerItem15 = QtGui.QSpacerItem(10, 10, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
...
"image sequences", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.details_item_tab.setTabText(self.details_item_tab.indexOf(self.property_settings_scroll_area), QtGui.QApplication.translate("Dialog", "Properties", None, QtGui.QApplication.UnicodeUTF8))
